...
var Xi = (() => {
  ...
  return function(a = {}) {
    ...
    function mr() {
      ...
      if (o.instantiateWasm)
        try {
          ...
          Z(`Module.instantiateWasm callback failed with error: ${n}`), T(n);
        }
      return _r(ae, ee, e, r).catch(T), {};
    }
    var De = (e) => {
      for (; e.length > 0; )
        e.shift()(o);
    ...
    var B = 8, Ir = (e, t, r, n) => {
      ...
      o.getInheritedInstanceCount = Or, o.getLiveInheritedInstances = Ur, o.flushPendingDeletes = Ue, o.setDelayFunction = Hr;
    }, ce = {}, Vr = (e, t) => {
...
` + i.replace(/^Error(:[^\n]*)?\n/, ""));
      ...
      He(C, function() {
        ...
        var x = new pe(v, p, true, false, false), E = new pe(v + "*", p, false, false, false), Y = new pe(v + " const*", p, false, true, false);
        return Lt[e] = { pointerType: E, constPointerType: Y }, At(C, P), [x, E, Y];
      });
    }, Ve = (e, t) => {
      for (var r = [], n = 0; n < e; n++)
        r.push(w[t + n * 4 >> 2]);
      ...
      var l = t[1] !== null && r !== null, d = sn(t), f = t[0].name !== "void", v = u - 2, m = new Array(v), h = [], C = [], F = function(...W) {
        ...
        function p(x) {
          if (d)
            ...
            for (var E = l ? 1 : 2; E < t.length; E++) {
              var Y = E === 1 ? S : m[E - 2];
              t[E].destructorFunction !== null && t[E].destructorFunction(Y);
            }
          if (f)
    ...
    var ln = (e, t, r, n, i, s) => {
      ...
      }, toWireType: (s, u) => u.value, argPackAdvance: B, readValueFromPointer: vn(t, r, n), destructorFunction: null }), He(t, i);
    }, qe = (e, t) => {
      var r = X[e];
      ...
      }, H(e, { name: t, fromWireType: s, toWireType: f, argPackAdvance: B, readValueFromPointer: gn(t, r, n !== 0), destructorFunction: null });
    }, Cn = (e, t, r) => {
      ...
      r = M(r);
      var n, i, s, u;
      t === 2 ? (n = Fn, i = $n, u = Pn, s = (l) => oe[l >> 1]) : t === 4 && (n = Ln, i = Mn, u = An, s = (l) => w[l >> 2]), H(e, { name: r, fromWireType: (l) => {
    ...
    var fi = (e, t) => {
      ...
      function m(c, p, x) {
        for (var E = typeof c == "number" ? c.toString() : c || ""; E.length < p; )
          E = x[0] + E;
        return E;
      }
      function h(c, p) {
      ...
      function C(c, p) {
        ...
        var E;
        return (E = x(c.getFullYear() - p.getFullYear())) === 0 && (E = x(c.getMonth() - p.getMonth())) === 0 && (E = x(c.getDate() - p.getDate())), E;
      }
      function F(c) {
        switch (c.getDay()) {
          case 0:
      ...
      function W(c) {
        var p = di(new Date(c.tm_year + 1900, 0, 1), c.tm_yday), x = new Date(p.getFullYear(), 0, 4), E = new Date(p.getFullYear() + 1, 0, 4), Y = F(x), Ae = F(E);
  ...
  static async _loadWithBackup() {
    return this._ModulePromise || (this._ModulePromise = this._tryLoad(this._wasmURL).catch(async (a) => {
      ...
      try {
        ...
        throw console.error(`Primary WASM URL failed: ${a.message}`), console.error(`Backup WASM URL failed: ${_.message}`), new Error("WASM loading failed from all sources.");
      }
    })), this._ModulePromise;
  }
  static async load() {
...
var Kt = class {
  ...
  _loadFromSrc(a) {
    async function o() {
      ...
      let T = (_.headers.get("content-type") ?? "").trim(), ie;
      return ["application/json", "text/plain"].some((me) => T.startsWith(me)) ? ie = await _.text() : ie = await _.arrayBuffer(), ie;
    }
    o().then((_) => {
  ...
  _loadFromData(a) {
    if (this._dotLottieCore === null)
      return;
    let o = this._canvas.width, _ = this._canvas.height, T = false;
    if (typeof a == "string")
      T = this._dotLottieCore.loadAnimationData(a, o, _);
    else if (a instanceof ArrayBuffer)
      T = this._dotLottieCore.loadDotLottieData(a, o, _);
    else if (typeof a == "object")
      T = this._dotLottieCore.loadAnimationData(JSON.stringify(a), o, _);
    else {
  ...
  _render() {
    ...
    if (this._dotLottieCore.render()) {
      let o = this._dotLottieCore.buffer(), _ = new Uint8ClampedArray(o, 0, this._canvas.width * this._canvas.height * 4), T = null;
      return typeof ImageData > "u" ? (T = this._context.createImageData(this._canvas.width, this._canvas.height), T.data.set(_)) : T = new ImageData(_, this._canvas.width, this._canvas.height), this._context.putImageData(T, 0, 0), this._eventManager.dispatch({ type: "render", currentFrame: this._dotLottieCore.currentFrame() }), true;
    }
    return false;
  }
  _draw() {
  ...
  resize() {
    if (tt && this._canvas instanceof HTMLCanvasElement) {
      let o = this._renderConfig.devicePixelRatio || window.devicePixelRatio || 1, { height: _, width: T } = this._canvas.getBoundingClientRect();
      this._canvas.width = T * o, this._canvas.height = _ * o;
    }
  ...
  markers() {
    ...
    if (a) {
      ...
      for (let _ = 0; _ < a.size(); _ += 1) {
        let T = a.get(_);
        o.push({ name: T.name, time: T.time, duration: T.duration });
      }
      return o;
    }
    return [];
  ...
  setViewport(a, o, _, T) {
    return this._dotLottieCore === null ? false : this._dotLottieCore.setViewport(a, o, _, T);
  }
  static setWasmUrl(a) {
    K.setWasmUrl(a);
  }
